...
import phone from "../Sections/../../../../assets/calling.png";
import decline from "../Sections/../../../../assets/dec.png";
import going from "../Sections/../../../../assets/outgoing-call.png";
  ...
  if (callAccepted) {
    meetingEndPeerButton = (
      <div className="disconnect">
        <button
          onClick={() => disconnectMeeting()}
          style={{ margin: 40, marginLeft: 615, marginTop: 5 }}
        >
          Disconnect
        </button>
      </div>
